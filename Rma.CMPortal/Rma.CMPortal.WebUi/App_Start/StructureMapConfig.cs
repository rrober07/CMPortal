...
[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(Rma.CMPortal.WebUi.StructureMapConfig), "Configure")]
	...
	public static class StructureMapConfig
	{
		public static void Configure()
		{
			IoC.Container.Configure(cfg =>
			{
				...
				cfg.AddRegistry(new ActionFilterRegistry(namespacePrefix: "Rma.CMPortal.WebUi"));
